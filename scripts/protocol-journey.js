...
(function(){
  ...
  async function getContents(protocol, progress, admin=false){
    ...
    // SAFE DAY LOCK:
    // Admin voit tout pour vérifier.
    // Cliente normale voit uniquement les contenus sans jour ou déjà débloqués.
    // Exemple: Jour 1 => day_number 1 uniquement. Jour 2 reste caché jusqu'au passage au jour 2.
