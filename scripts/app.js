...
async function renderHomeFeed() {
  ...
  el.innerHTML = posts.map(p => `
    <article class="post-card reveal">
      <div class="post-head"><span class="avatar">T</span><div><strong>Méthode Tee</strong><small>${new Date(p.created_at).toLocaleString("fr-FR")}</small></div><span class="tag">${p.type || "Journal"}</span></div>
