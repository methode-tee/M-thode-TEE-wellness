/* MÉTHODE TEE · V4896630 · reveal repas plus délicat, récap plus premium et transition sans couture
...
(function(){
  ...
  function injectCSS(){if(document.getElementById('mtFoodGuidanceCSS'))return;const s=document.createElement('style');s.id='mtFoodGuidanceCSS';s.textContent=`
    ...
    .mt-food-guide-stage{position:relative}.mt-food-guide-transition{display:flex;align-items:center;gap:10px;margin:11px 0 2px;padding:10px 12px;border-radius:13px;background:rgba(255,250,242,.78);border:1px solid #eadfc9;color:#587168;font-size:11.5px;font-weight:750;line-height:1.35;opacity:0;transform:translateY(4px);animation:mtGuideTransitionIn .42s cubic-bezier(.22,1,.36,1) forwards;transition:opacity .28s cubic-bezier(.22,1,.36,1),transform .28s cubic-bezier(.22,1,.36,1),filter .26s ease;filter:blur(.6px)}.mt-food-guide-transition.is-handoff{margin:0 0 10px;opacity:1;transform:none;filter:none;animation:none}.mt-food-guide-transition.is-leaving{opacity:0!important;transform:translateY(-2px)!important;filter:blur(.9px)!important}.mt-food-guide-transition-mark{width:7px;height:7px;border-radius:999px;background:#a77f35;box-shadow:0 0 0 4px rgba(167,127,53,.09);flex:0 0 auto}.mt-food-guide-transition-dots{display:inline-flex;gap:3px;margin-left:auto;flex:0 0 auto}.mt-food-guide-transition-dots i{width:4px;height:4px;border-radius:99px;background:#a77f35;opacity:.28;animation:mtGuideDot 1.15s ease-in-out infinite}.mt-food-guide-transition-dots i:nth-child(2){animation-delay:.16s}.mt-food-guide-transition-dots i:nth-child(3){animation-delay:.32s}.mt-food-guide-build-shell{display:grid;grid-template-rows:1fr;opacity:1;transform:translateY(0);filter:blur(0)}.mt-food-guide-build-shell>.mt-food-guide-build{min-height:0;overflow:hidden}.mt-food-guide-build-shell.is-entering{grid-template-rows:0fr;opacity:0;transform:translateY(6px);filter:blur(1px);transition:grid-template-rows .68s cubic-bezier(.22,1,.36,1),opacity .54s cubic-bezier(.22,1,.36,1) .02s,transform .68s cubic-bezier(.22,1,.36,1),filter .46s ease;will-change:grid-template-rows,opacity,transform,filter}.mt-food-guide-build-shell.is-entering.is-visible{grid-template-rows:1fr;opacity:1;transform:translateY(0);filter:blur(0)}.mt-food-guide-build-shell.is-entering .mt-food-guide-build-title,.mt-food-guide-build-shell.is-entering .mt-food-guide-selected,.mt-food-guide-build-shell.is-entering .mt-food-guide-build>[data-mt-guide-reset]{opacity:0;transform:translateY(4px)}.mt-food-guide-build-shell.is-entering.is-visible .mt-food-guide-build-title{opacity:1;transform:translateY(0);transition:opacity .46s ease .08s,transform .58s cubic-bezier(.22,1,.36,1) .05s}.mt-food-guide-build-shell.is-entering.is-visible .mt-food-guide-selected{opacity:1;transform:translateY(0);transition:opacity .52s ease .12s,transform .62s cubic-bezier(.22,1,.36,1) .08s}.mt-food-guide-build-shell.is-entering.is-visible .mt-food-guide-selected:nth-of-type(2){transition-delay:.16s,.12s}.mt-food-guide-build-shell.is-entering.is-visible .mt-food-guide-selected:nth-of-type(3){transition-delay:.20s,.16s}.mt-food-guide-build-shell.is-entering.is-visible .mt-food-guide-build>[data-mt-guide-reset]{opacity:1;transform:translateY(0);transition:opacity .46s ease .20s,transform .56s cubic-bezier(.22,1,.36,1) .16s}.mt-food-guide-next-step-shell{display:grid;grid-template-rows:1fr;opacity:1;transform:translateY(0);filter:blur(0)}.mt-food-guide-next-step-shell>.mt-food-guide-next-step{min-height:0;overflow:hidden}.mt-food-guide-next-step-shell.is-entering{grid-template-rows:0fr;opacity:0;transform:translateY(7px);filter:blur(1px);transition:grid-template-rows .78s cubic-bezier(.22,1,.36,1),opacity .66s cubic-bezier(.22,1,.36,1) .06s,transform .78s cubic-bezier(.22,1,.36,1) .02s,filter .52s ease .02s;will-change:grid-template-rows,opacity,transform,filter}.mt-food-guide-next-step-shell.is-entering.is-visible{grid-template-rows:1fr;opacity:1;transform:translateY(0);filter:blur(0)}.mt-food-guide-next-step-shell.is-entering .mt-food-guide-step-hint,.mt-food-guide-next-step-shell.is-entering .mt-food-guide-options,.mt-food-guide-next-step-shell.is-entering .mt-food-guide-gesture{opacity:0;transform:translateY(5px)}.mt-food-guide-next-step-shell.is-entering.is-visible .mt-food-guide-step-hint{opacity:1;transform:translateY(0);transition:opacity .56s ease .12s,transform .66s cubic-bezier(.22,1,.36,1) .08s}.mt-food-guide-next-step-shell.is-entering.is-visible .mt-food-guide-options,.mt-food-guide-next-step-shell.is-entering.is-visible .mt-food-guide-gesture{opacity:1;transform:translateY(0);transition:opacity .64s ease .18s,transform .72s cubic-bezier(.22,1,.36,1) .14s}@keyframes mtGuideTransitionIn{to{opacity:1;transform:translateY(0);filter:blur(0)}}@keyframes mtGuideDot{0%,72%,100%{opacity:.2;transform:translateY(0)}36%{opacity:.82;transform:translateY(-1.5px)}}@media (prefers-reduced-motion:reduce){.mt-food-guide-transition,.mt-food-guide-transition-dots i{animation:none!important;opacity:1!important;transform:none!important;filter:none!important}.mt-food-guide-build-shell,.mt-food-guide-build-shell.is-entering,.mt-food-guide-build-shell.is-entering.is-visible,.mt-food-guide-next-step-shell,.mt-food-guide-next-step-shell.is-entering,.mt-food-guide-next-step-shell.is-entering.is-visible{grid-template-rows:1fr!important;opacity:1!important;transform:none!important;filter:none!important;transition:none!important}.mt-food-guide-build-shell.is-entering .mt-food-guide-build-title,.mt-food-guide-build-shell.is-entering .mt-food-guide-selected,.mt-food-guide-build-shell.is-entering .mt-food-guide-build>[data-mt-guide-reset],.mt-food-guide-next-step-shell.is-entering .mt-food-guide-step-hint,.mt-food-guide-next-step-shell.is-entering .mt-food-guide-options,.mt-food-guide-next-step-shell.is-entering .mt-food-guide-gesture{opacity:1!important;transform:none!important;transition:none!important}}
  ...
  function structuredRoleFocus(group){
    return group==='protein'?'protein':group==='starch'?'carbs':group==='vegetable'?'fiber':'protein';
  }
  function nextStructuredMealRole(build){
    const groups=new Set((Array.isArray(build?.items)?build.items:[]).map(x=>String(x?.group||'')));
  ...
  function structuredRoleStep(group){return group==='protein'?1:group==='starch'?2:group==='vegetable'?3:3;}
  function structuredRoleStepLabel(group){
  ...
  function structuredGuideCopy(build,state){
    const items=Array.isArray(build?.items)?build.items:[],groups=new Set(items.map(x=>String(x?.group||'')));
  ...
  function mealRoleMetricLine(c,group,focus){
    ...
    else if(group==='vegetable'&&n(c?.fiber_g)>0)bits.push(`${fmt(c.fiber_g,1)} g fibres`);
  ...
  function rolePayloadFor(payload,group,focus){
    if(structuredRoleFocus(group)===focus)return payload;
  ...
  async function ensureStructuredRoleSupport(payload,model,focus,state,build,requestedRole=null){
    if(!payload||!['lunch','dinner'].includes(String(state?.mealContext||'')))return payload;
    const group=requestedRole||nextStructuredMealRole(build);
    if(!group||!['protein','starch','vegetable'].includes(group))return payload;
    const roleFocus=structuredRoleFocus(group);
  ...
  function sortedStructuredRoleCandidates(payload,model,focus,state,group){
    const sources=[];
    ...
    for(const src of sources){
      ...
      for(const c of sortedCandidates(src.payload,model,src.focus,roleState)){
  ...
  function structuredTransitionHTML(copy,handoff=false){
    return `<div class="mt-food-guide-transition${handoff?' is-handoff':''}" role="status" aria-live="polite"><span class="mt-food-guide-transition-mark" aria-hidden="true"></span><span>${esc(copy||'')}</span><span class="mt-food-guide-transition-dots" aria-hidden="true"><i></i><i></i><i></i></span></div>`;
  }
  
  function structuredTransitionCopy(group,state){
    const meal=String(state?.mealContext||'')==='lunch'?'déjeuner':'dîner';
  ...
  function showStructuredTransition(host,group,state){
    ...
    el.innerHTML=structuredTransitionHTML(structuredTransitionCopy(group,state),false).replace(/^<div[^>]*>|<\/div>$/g,'');
  ...
  function renderHost(host,{model,decision,payload,experience=false,start=0,browseRole=null,animateStep=false,transitionHandoff=null}){
    ...
    const ranked=sortedCandidates(payload,model,focus,state),structuredMainMeal=['lunch','dinner'].includes(String(slot?.context||'')),build=loadMealBuildState(state);
    const selectedMealGroups=new Set((build.items||[]).map(x=>String(x?.group||'')));
    const nextRole=structuredMainMeal?nextStructuredMealRole(build):null;
    const rolePool=structuredMainMeal&&(browseRole||nextRole)?sortedStructuredRoleCandidates(payload,model,focus,state,browseRole||nextRole):null;
    let candidates;
    ...
    const guideCopy=browseRole?'Choisis simplement l’alternative qui te convient pour ce rôle. Le reste de ton repas ne change pas.':(structuredMainMeal?structuredGuideCopy(build,state):pacingCopy(model,payload,focus));
    ...
    const stepHint=stepRole&&['protein','starch','vegetable'].includes(stepRole)?`<div class="mt-food-guide-step-hint"><span>${structuredRoleStep(stepRole)}/3</span>${esc(structuredRoleStepLabel(stepRole))}</div>`:'';
    ...
    const handoffHTML=transitionHandoff?structuredTransitionHTML(transitionHandoff,true):'';
    const buildSummaryHTML=buildSummary?`<div class="mt-food-guide-build-shell${animateStep&&structuredMainMeal?' is-entering':''}">${buildSummary}</div>`:'';
    host.innerHTML=`<section class="mt-food-guide"><div class="mt-food-guide-kicker">${esc(slotKicker)}</div><h3>${esc(slotTitle)}</h3><p>${esc(guideCopy)}</p>${gesture?`<div class="mt-food-guide-gesture"><b>Jour ${gesture.day}/7 · le geste d’aujourd’hui</b>${esc(gesture.text)}</div>`:''}<div class="mt-food-guide-stage">${handoffHTML}${buildSummaryHTML}<div class="mt-food-guide-next-step-shell${animateStep?' is-entering':''}"><div class="mt-food-guide-next-step">${nextStepHTML}</div></div><div class="mt-food-guide-actions">${topActions}${addAction}<button type="button" class="mt-food-guide-btn${(build.items||[]).length?'':' primary'}" data-mt-guide-adapter>${esc(adapterActionLabel(state))}</button></div><p class="mt-food-guide-note">Un choix reste une intention tant que tu n’as pas confirmé ce que tu as réellement mangé.</p></div></section>`;
    if(animateStep){
      const buildShell=host.querySelector('.mt-food-guide-build-shell.is-entering');
      const nextStepShell=host.querySelector('.mt-food-guide-next-step-shell.is-entering');
      const handoff=host.querySelector('.mt-food-guide-transition.is-handoff');
      if(buildShell){
        buildShell.classList.remove('is-visible');
        void buildShell.offsetHeight;
      }
      if(nextStepShell){
      ...
      requestAnimationFrame(()=>requestAnimationFrame(()=>{
        if(buildShell)buildShell.classList.add('is-visible');
        if(nextStepShell)setTimeout(()=>nextStepShell.classList.add('is-visible'),34);
        if(handoff){
          setTimeout(()=>handoff.classList.add('is-leaving'),74);
    ...
    const bindPickButtons=(root)=>{
      root.querySelectorAll('[data-mt-guide-pick]').forEach(btn=>btn.addEventListener('click',async()=>{
        ...
        if(structuredMainMeal){
          ...
          handoffCopy=structuredTransitionCopy(group,state);
          if(transition){transition.classList.add('is-leaving');await sleep(140);}
        }
        renderHost(host,{model,decision,payload,experience,start:0,browseRole:null,animateStep:structuredMainMeal,transitionHandoff:handoffCopy});return;
      }));
      if(structuredMainMeal){
    ...
    host.querySelector('[data-mt-guide-to-meal]')?.addEventListener('click',async()=>{await log('meal_confirmation_opened',focus,null,{mealContext:state?.mealContext||null,payload:{source:'tee_guidance',intent_only:true,items:(build.items||[]).map(x=>({name:x.name,portion_g:x.portion_g}))}});openGuidanceMealDraft(state,build,focus);});
  ...
  async function mount(opts={}){
    ...
    try{
      ...
      if(state.phase!=='closing'&&!state.veryLate&&!['slot_already_logged','optional_slot_no_need'].includes(String(payload?.client_guidance_mode||''))){
        ...
        else if(mainMeal){const role=nextStructuredMealRole(mountedBuild);first=role?sortedStructuredRoleCandidates(payload,opts.model,focus,state,role).slice(0,1):[];}
