(function(root,factory){
  ...
  const PHRASE_RULES=[
    ...
    {id:'cured_meat',re:/\b(jambon(?:\s+(?:blanc|cru|sec|de\s+dinde))?|lardons?|bacon|pancetta|chorizo|coppa|speck|prosciutto)\b/,roles:['protein'],traits:['meat','cured_meat']},
    ...
    {id:'bean_ambiguous',re:/\bharicots?\b(?!\s+(?:verts?|rouges?|blancs?|noirs?|secs?|coco|borlotti|azuki|mung|mungo|beurre))/,roles:['protein','vegetable'],traits:['ambiguous_bean']},
    {id:'pulse',re:/\b(lentilles?|pois\s+chiches?|haricots?\s+(rouges?|blancs?|noirs?|secs?|coco|borlotti|azuki|mung|mungo|beurre)|flageolets?|feves?|fèves?|pois\s+casses?|niebe|niébé|cowpea|bambara|edamame|soja|tofu|tempeh|seitan)\b/,roles:['protein'],traits:['plant_protein','pulse']},
  ...
  const CULTURES={
    ...
    east_africa:{label:'Afrique de l’Est',signals:/\b(injera|doro\s+wat|misir\s+wat|shiro|ugali|sukuma\s+wiki|pilau|matoke|nyama\s+choma|berbere|berbéré)\b/,
      forms:{grain:['Pilau parfumé & légumes','Bowl de céréales & sauce épicée douce','Riz aux aromates & garniture','Assiette céréale-légumes'],tuber:['Matoke/plantain mijoté & garniture','Tubercule & légumes braisés','Base vapeur & sauce tomate-oignon','Assiette plantain & protéines'],mixed:['Mijoté tomate-aromates','Assiette grillée & légumes','Sauce de légumineuses & base','Bowl chaud aux légumes']},
      finish:['sukuma/chou vert sauté','tomate-oignon-coriandre','lentilles épicées douces','haricots tomate-oignon','carottes au cumin','concombre-citron','herbes fraîches & citron','avocat & tomate']},
