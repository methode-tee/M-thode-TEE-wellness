...
function mtProtocolLens(protocol){
  ...
  const explicit=[
    ...
    [/perimenopause|menopause/,{kind:'perimenopause',keys:['perimenopause'],title:'Tes repères de transition hormonale',subtitle:'Une lecture descriptive des symptômes et ressentis réellement présents.',health:[]}],
