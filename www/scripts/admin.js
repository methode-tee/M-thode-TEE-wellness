...
async function editFoodGuidanceProfile(profileKey){
  ...
  document.getElementById('foodGuidancePortion').value=x.guidance_portion_g??100;document.getElementById('foodGuidanceQuality').value=String(x.quality_rank??1);document.getElementById('foodGuidanceReady').checked=x.ready_to_eat!==false;document.getElementById('foodGuidancePreparation').value=x.preparation_state||'ready';
...
async function saveFoodGuidanceAdmin(e){
  ...
  const payload={auto_suggest_mode:document.getElementById('foodGuidanceMode').value,guidance_role:document.getElementById('foodGuidanceRole').value,guidance_portion_g:Number(document.getElementById('foodGuidancePortion').value),quality_rank:Number(document.getElementById('foodGuidanceQuality').value),ready_to_eat:document.getElementById('foodGuidanceReady').checked,preparation_state:document.getElementById('foodGuidancePreparation').value,contexts:mtFoodList(document.getElementById('foodGuidanceContexts').value),nutrient_scores:scores,admin_note:String(document.getElementById('foodGuidanceNote').value||'').trim()};
